...
public class SettingsActivity extends PreferenceActivity {
	...
	public static int getSpecturmBackColor(Context context)
	{
		return PreferenceManager.getDefaultSharedPreferences(context).getInt("settings_val_color_specturm",0x00);
	}
	public static int getWaveBackColor(Context context)
	{
		return PreferenceManager.getDefaultSharedPreferences(context).getInt("settings_val_color_wave",0x00);
	}
	
	public static boolean getIsKeepOn(Context context)
	{
		return PreferenceManager.getDefaultSharedPreferences(context).getBoolean("settings_val_bool_iskeepon",false);
	}
